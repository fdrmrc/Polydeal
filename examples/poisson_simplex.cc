...
Poisson<dim>::make_grid()
{
  ...
  if (grid_type == GridType::unstructured)
    ...
    {
      Triangulation<dim> hyper_cube_tria;
      GridGenerator::hyper_cube(hyper_cube_tria, 0., 1.);
      hyper_cube_tria.refine_global(4);
      GridGenerator::convert_hypercube_to_simplex_mesh(hyper_cube_tria, tria);
    }
