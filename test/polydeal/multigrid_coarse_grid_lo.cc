...
// Same test in dealii/tests/multigrid/step-16-50.cc, but with a
// CoarseGridSolver initialized with a LinearOperator.
...
LaplaceProblem<dim>::solve()
{
  ...
  MGCoarseGridIterativeSolverLO<vector_t,
                                SolverCG<vector_t>,
  ...
  std::cout << "Converged in " << solver_control.last_step() << " iterations."
            << " with value " << solver_control.last_value() << std::endl;
