...
// Similar to distributed_poisson_sanity_check_01.cc, but with a fully
...
main(int argc, char *argv[])
{
  ...
  // First, create a parallel distributed triangulation.
  ...
  //   actually build the fully distributed tria
